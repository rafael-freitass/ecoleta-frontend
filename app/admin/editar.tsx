...
import { buscarPontoPorId, atualizarPonto, Ponto } from "../../src/api/pontoColeta/pontoColeta";
...
export default function Editar(){
    ...
    async function carregar(){
        const dados = await buscarPontoPorId(Number(id));
        setPonto(dados);
    }
    ...
    return (
        <View style={style.container}>
            <PontoForm ponto={ponto} onSubmit={salvar}/>
        </View>
    )
}